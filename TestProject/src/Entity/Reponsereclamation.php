 ...
 * Reponsereclamation
 *
 * @ORM\Table(name="reponsereclamation", indexes={@ORM\Index(name="textRec", columns={"intitule"}), @ORM\Index(name="Prenom", columns={"Prenom"}), @ORM\Index(name="idU", columns={"idU"}), @ORM\Index(name="idRec", columns={"idRec"})})
 * @ORM\Entity
 */
