...
//*****************************************************************************************user back ***********************************************************************
    ...
    public function search(Request $request, UserRepository $user)
    {
        $users = $user->findAll();
        ...
        if ($searchForm->isSubmitted()) {
            $searchTerm = $searchForm['last_Name']->getData();
            $resultOfSearch = $user->findByUsername($searchTerm);
    
            return $this->renderForm('backend/search.html.twig', [
                'users' => $resultOfSearch,
                'search' => $searchForm,
            ]);
        }
